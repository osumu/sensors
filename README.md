...
自学ノートで超音波について調べて、超音波が使われているものを調べている中で超音波センサーについて知り、弱点があることもわかったので、複数のセンサーを組み合わせれば弱点を補えることができるのではないかと考えて、センサー融合について調べてみることにしました。
...
超音波は距離(の変化)はわかるが人と物を区別できない、人感は動いている人を検知できるが止まっている人を検知できない、光は明るさだけしかわからないので組み合わせることで人と物の区別、人や物が動いているかどうかの区別、距離、明るさがわかるようになるのではないか

<img src="image.jpg" alt="装置の画像" width="500" height="375">
<small style="text-align:center">装置の画像</small>
...
|物が動く|1→0.5m|97.9 cm, 85.1 cm, 71.0 cm, 58.3 cm, 46.0 cm|OFF|860\~880|
...
|-|-|-|-|-|-|
|状態|距離設計|超音波|人感|光|判定|
|歩く|1.2→0.8m|119.3 cm,  121.6 cm,  114.3 cm,  99.0 cm,  85.9 cm|ON,  ON,  ON,  ON,  ON|284,  309,  303,  278,  275|人が近付いた判定|
|物が動く|1→0.5m|97.9 cm,  85.1 cm,  71.0 cm,  58.3 cm,  46.0 cm|OFF,  OFF,  OFF,  OFF,  OFF|285,  284,  285,  285,  285,|物が動いた判定|
...
超音波、人感、光センサーなどのセンサーについて詳しく調べて知ることができて、そして実際に使ってみて誤差などの修正が難しかったですが、特徴や問題点などを計測することができました。誤差には止まっている人を物体と誤判定（コード側で修正) 、人感センサーがすぐOFFになる（コード側で修正) 、超音波センサーから直線上の距離にたっていないと反応しない（物体を大きくした) などでした。なのでセンサーから得た情報の組み合わせが重要だと思います。
